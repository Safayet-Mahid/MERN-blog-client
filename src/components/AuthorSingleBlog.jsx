...
const AuthorSingleBlog = () => {
  return (
    <div className='flex flex-col gap-y-4 md:flex-row md:gap-x-3 lg:gap-x-6 mb-12 hover:bg-slate-200 hover:shadow-md p-4'>
    {/* img  */}
    <div className='  rounded-full md:self-center'>
        <img src="https://www.theinertia.com/wp-content/uploads/2020/05/Campervans-670x447.jpg" className='h-36 w-36 rounded-lg md:rounded-full' alt="" />
    </div>
...
export default AuthorSingleBlog